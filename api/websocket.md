...
identities before reconnecting. The web client rebuilds inventory and replay if
deletion invalidates a subscription or races an event-reference fetch. The
