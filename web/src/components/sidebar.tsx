  ...
  return (
    ...
    >
      <div className={sidebarRowClass}>
        <Button
          variant="ghost"
          className={`h-auto min-w-0 flex-1 justify-start py-2 font-normal text-foreground ${selected ? "shadow-sm bg-sidebar hover:bg-sidebar dark:hover:bg-sidebar" : ""} ${running ? "agent-running" : ""}`}
          render={
            <Link
            ...
            <div data-project-id={project.id} className={sidebarRowClass}>
              <CollapsibleTrigger
                render={
                  <Button
                    variant="ghost"
                    className="group min-w-0 flex-1 justify-start shadow-sm bg-sidebar aria-expanded:bg-sidebar font-semibold hover:bg-sidebar dark:hover:bg-sidebar"
                  />
                }
              >
