...
export interface paths {
    ...
    "/v1/projects/{project_id}": {
        ...
        put?: never;
        post?: never;
        /** @description Delete a project and all its settled agents and chat history. Returns 409 while any agents are unsettled or still stopping. The project directory is not removed. */
